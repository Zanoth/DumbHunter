...
public class WeaponManager
{
  ...
  public WeaponManager(IRepository<WeaponId, IWeapon> weaponRepository, IRepository<SkillId, Skill> skillRepository)
  {
  ...
  //}
  //private void WriteWeaponSpecs(IWeapon weaponBase)
  //{
  ...
  //  var elementalStats = weaponBase.ElementalStats.ToList();
  //  var sharpnessSections = weaponBase.Sharpness.Sections.ToList();
  //  var decorationSlots = weaponBase.DecorationSlots.ToList();
  //  var weaponSkills = weaponBase.Skills.ToList();
  ...
  //  {
  //    var idStr = i == 0 ? weaponBase.WeaponId.Id : "";
  //    var nameStr = i == 0 ? weaponBase.Name : "";
  //    var typeStr = i == 0 ? weaponBase.WeaponType.ToString() : "";
  //    var rarityStr = i == 0 ? weaponBase.Rarity.ToString() : "";
  //    var attackStr = i == 0 ? weaponBase.Attack.ToString() : "";
  //    var affinityStr = i == 0 ? weaponBase.Affinity.ToString() : "";
  //    var eldersealStr = i == 0 ? weaponBase.Elderseal.ToString() : "";
  ...
  //    var sharpnessSectionsStr = i < sharpnessSections.Count && sharpnessSections.Count > 0 ? $"[{sharpnessSections[i].Color}] - {sharpnessSections[i].Value}" : "";
