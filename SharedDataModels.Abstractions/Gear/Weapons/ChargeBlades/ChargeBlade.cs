...
namespace SharedDataModels.Abstractions.Gear.Weapons.ChargeBlades;

public class ChargeBlade : IChargeBlade
{
    public ChargeBlade(WeaponId weaponId,
      string name,
      int rarity,
      int attack,
      int affinity,
    ...
    public WeaponType WeaponType { get; } = WeaponType.ChargeBlade;
