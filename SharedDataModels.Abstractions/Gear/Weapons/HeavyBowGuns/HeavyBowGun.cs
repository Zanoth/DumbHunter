...
namespace SharedDataModels.Abstractions.Gear.Weapons.HeavyBowGuns;

public class HeavyBowGun : IHeavyBowGun
{
    public HeavyBowGun(WeaponId weaponId,
      string name,
      int rarity,
      int attack,
      int affinity,
    ...
    public WeaponType WeaponType { get; } = WeaponType.HeavyBowGun;
