...
namespace SharedDataModels.Abstractions.Gear.Weapons.Gunlances;

public class Gunlance : IGunlance
{
  public Gunlance(WeaponId weaponId,
    string name,
    int rarity,
    int attack,
    int affinity,
    ...
    Sharpness sharpness,
    ShellingMechanic shellingMechanic)
  {
    WeaponId = weaponId;
    Name = name;
    Rarity = rarity;
  ...
  public WeaponType WeaponType { get; } = WeaponType.Gunlance;
