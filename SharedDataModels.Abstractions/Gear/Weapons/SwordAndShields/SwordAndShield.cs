...
namespace SharedDataModels.Abstractions.Gear.Weapons.SwordAndShields;

public class SwordAndShield : ISwordAndShield
{
    public SwordAndShield(WeaponId weaponId,
      string name,
      int rarity,
      int attack,
      int affinity,
    ...
    public WeaponType WeaponType { get; } = WeaponType.SwordAndShield;
